...
public extension YYRefresh {
    ...
    struct Config {
        ...
        public var animateDurationParking = 0.25
        public var animateDurationStateSwitching = 0.4
...
extension YYRefresh {
    ...
    static func imageFromBundle(named: String) -> UIImage? {
        if let path = Bundle(for: self).resourcePath?.appending("/YYRefresh.bundle/") {
            return UIImage(named: named, in: Bundle(path: path), compatibleWith: nil)
        }
